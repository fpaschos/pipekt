 ...
 * restart recovery.
 *
 * The [planVersion] is the logical version of the compiled pipeline plan. [DurableStore.getOrCreateRun]
 ...
 * or execution for this run. [DurableStore.listActiveRuns] excludes [STATUS_FAILED] runs.
 *
 ...
 *   `PipelineDefinition`. Used together with [planVersion] as the lookup key in [DurableStore.getOrCreateRun].
 * @param planVersion Logical version of the compiled pipeline plan. [DurableStore.getOrCreateRun]
 ...
 *   permanently unusable; excluded from [DurableStore.listActiveRuns] and active-run indices).
...
data class RunRecord(
    ...
    companion object {
         ...
         * [DurableStore.listActiveRuns] and the active-run Postgres index. Infinite runs
